<script setup lang="ts">
  ...
  /* ── 折线图数据 ── */
  const days = ['2/23', '2/24', '2/25', '2/26', '2/27', '2/28', '3/1']
  const spend = [1650, 1720, 1580, 1890, 1760, 1840, 1760]
  const profit = [620, 680, 590, 720, 680, 710, 660]
  const roi = [36, 39, 35, 41, 38, 40, 38]

  /* ── 渠道饼图数据 ── */
  const channelData = [
    { value: 5200, name: '谷歌', itemStyle: { color: '#3b82f6' } },
    { value: 3400, name: 'Meta', itemStyle: { color: '#60a5fa' } },
    { value: 1700, name: 'TikTok', itemStyle: { color: '#10b981' } },
    { value: 1220, name: 'ASA', itemStyle: { color: '#f59e0b' } },
    { value: 680, name: '其他', itemStyle: { color: '#4b5563' } }
  ]
        ...
        graphic: [
          {
            ...
            children: [
              {
                type: 'text',
                style: { text: '总支出', fill: '#94a3b8', fontSize: 11, textAlign: 'center' },
                left: 'center',
                top: -12
              },
              {
...
<template>
  <div class="summary-tab">
    ...
    <div class="stat-cards">
      <!-- 本期广告支出 -->
      <div class="stat-card" style="border-color: #0d9488">
        ...
        <div class="stat-row">
          ...
          <span style="color: #f97316">-$720</span>
        </div>
        <div class="stat-row mt4">
          <span class="label-dim">上期 $11,250</span>
          <span class="sep">|</span>
          <span style="color: #10b981">环比 +8.5%</span>
        </div>
      </div>
      ...
      <div class="stat-card" style="border-color: #2563eb">
        ...
        <div class="stat-main" style="color: #60a5fa">73.4%</div>
        <div class="stat-row">
          <span class="label-dim">代投</span>
          <span style="color: #f1f5f9">$8,960</span>
          <span class="sep">/</span>
          <span class="label-dim">直投</span>
          <span style="color: #f1f5f9">$2,520</span>
        </div>
        <div class="stat-row mt4">
          <span class="label-dim">上期占比 71.3%</span>
          <span class="sep">|</span>
          <span style="color: #10b981">环比 +2.1%</span>
        </div>
      </div>
      ...
      <div class="stat-card" style="border-color: #d97706">
        ...
        <div class="stat-main" style="color: #f59e0b">38.2%</div>
        <div class="stat-row">
          <span class="label-dim">目标</span>
          <span style="color: #f1f5f9">35.0%</span>
          <span class="sep">|</span>
          <span class="label-dim">超目标</span>
          <span style="color: #10b981">+3.2%</span>
        </div>
        <div class="stat-row mt4">
          <span class="label-dim">上期 36.1%</span>
          <span class="sep">|</span>
          <span style="color: #10b981">环比 +2.1pp</span>
        </div>
      </div>
      ...
      <div class="stat-card" style="border-color: #059669">
        ...
        <div class="stat-main" style="color: #10b981">$4,660</div>
        <div class="stat-row">
          <span class="label-dim">最低利润</span>
          <span style="color: #f1f5f9">$2,100</span>
          <span class="sep">|</span>
    ...
    <div class="charts-row">
      ...
      <div class="chart-card chart-pie">
        <div class="chart-header">
          <span class="chart-title">广告支出渠道分布</span>
        </div>
    ...
    <div class="bottom-row">
      ...
      <div class="chart-card bottom-bar">
        ...
        <div class="app-bars">
          <div class="app-bar-item">
            <div class="app-bar-label">天气预报</div>
            <div class="app-bar-track">
              <div class="app-bar-fill" style="width: 59%; background: #10b981"></div>
            </div>
            <span class="app-bar-pct" style="color: #10b981">59%</span>
            <span class="app-bar-amt">$7,300</span>
            <span class="app-bar-roi" style="color: #10b981">首日ROI 39.2% ▲</span>
          </div>
          <div class="app-bar-item">
            <div class="app-bar-label">血糖监测</div>
            <div class="app-bar-track">
              <div class="app-bar-fill" style="width: 26%; background: #60a5fa"></div>
            </div>
            <span class="app-bar-pct" style="color: #60a5fa">26%</span>
            <span class="app-bar-amt">$3,200</span>
            <span class="app-bar-roi" style="color: #ef4444">首日ROI 29.4% ▼</span>
          </div>
          <div class="app-bar-item">
            <div class="app-bar-label">手机追踪</div>
            <div class="app-bar-track">
              <div class="app-bar-fill" style="width: 15%; background: #a78bfa"></div>
            </div>
            <span class="app-bar-pct" style="color: #a78bfa">15%</span>
            <span class="app-bar-amt">$1,700</span>
            <span class="app-bar-roi" style="color: #10b981">首日ROI 36.5% ▲</span>
          </div>
      ...
      <div class="chart-card bottom-progress">
        <div class="chart-header">
          ...
          <span class="badge-warn">当前周期剩余 3天</span>
        </div>
