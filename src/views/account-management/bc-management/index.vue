<template>
  <div class="account-sub-page art-full-height">
      ...
      <div class="account-sub-page__toolbar-row">
        <div class="account-sub-page__toolbar-copy">
          ...
          <div class="account-sub-page__toolbar-titles">
            <span class="account-sub-page__toolbar-eyebrow">BC / BM</span>
            <span class="account-sub-page__toolbar-title">快捷操作</span>
          </div>
          <span class="account-sub-page__toolbar-hint">新建、导出与搜索 BM</span>
        </div>
        <div class="account-sub-page__toolbar-actions">
          <ElButton type="primary" round class="account-sub-page__btn-primary" @click="handleNew">
    ...
    <div class="main-content">
      <div class="list-side">
        <section class="account-sub-page__list-panel" aria-label="BC 列表">
      ...
      <div class="detail-side">
        <section class="account-sub-page__detail-panel" aria-label="BC 详情">
