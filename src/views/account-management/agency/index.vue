<template>
  <div class="account-sub-page art-full-height">
      ...
      <div class="account-sub-page__toolbar-row">
        <div class="account-sub-page__toolbar-copy">
          ...
          <div class="account-sub-page__toolbar-titles">
            <span class="account-sub-page__toolbar-eyebrow">Agency</span>
            <span class="account-sub-page__toolbar-title">快捷操作</span>
          </div>
          <span class="account-sub-page__toolbar-hint">新建、导出与搜索代理商</span>
        </div>
    ...
    <div class="main-content">
      <div class="list-side">
        <section class="account-sub-page__list-panel" aria-label="代理商列表">
      ...
      <div class="detail-side">
        <section class="account-sub-page__detail-panel" aria-label="代理商详情">
...
<script setup lang="ts">
  ...
  const handleFormSuccess = async (data: any) => {
    ...
    if (wasEditing && editData.value?.id && !AccountApiSource.updateAgency) {
      try {
        await updateAgency(editData.value.id, data)
      } catch {
        /* backend not ready */
      }
    }
  ...
  const handleDeleteConfirm = async () => {
    ...
    if (!AccountApiSource.deleteAgency) {
      try {
        await deleteAgency(deleteTarget.value.id)
      } catch {
        /* backend not ready */
      }
    }
