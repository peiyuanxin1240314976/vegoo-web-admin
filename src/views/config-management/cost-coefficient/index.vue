...
<script setup lang="ts">
  ...
  function normalizeCostCoefficientItem(raw: Record<string, unknown>): CostCoefficientItem {
    return {
      ...
      tstart: String(raw.tstart ?? raw.tStart ?? raw.t_start ?? ''),
      dcostRatio: pickFiniteNumber(raw.dcostRatio ?? raw.dCostRatio ?? raw.d_cost_ratio, 0),
      dinstallCost: pickFiniteNumber(raw.dinstallCost ?? raw.dInstallCost ?? raw.d_install_cost, 0),
