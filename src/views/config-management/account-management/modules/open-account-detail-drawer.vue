      ...
      <div class="drawer-body">
          ...
          <div class="info-grid">
            ...
            <div class="info-item">
              ...
              <span
                :class="[
                  'platform-badge',
                  data?.platform === 'iOS' ? 'platform-badge--ios' : 'platform-badge--android'
                ]"
              >
                {{ data?.platform }}
              </span>
        ...
        <section class="detail-section">
          <div class="section-header">
            ...
            <span class="feishu-on-badge"> <span class="feishu-dot-sm" />飞书已开启 </span>
          </div>
          <div v-if="data?.feishuRecords.length" class="feishu-timeline">
            <div v-for="(rec, i) in data.feishuRecords" :key="i" class="feishu-item">
              <span
                :class="[
                  'feishu-item-dot',
                  rec.result === '成功' ? 'feishu-item-dot--ok' : 'feishu-item-dot--fail'
                ]"
              />
              <div class="feishu-item-body">
                <div class="feishu-item-top">
                  ...
                  <span
                    :class="[
                      'feishu-result',
                      rec.result === '成功' ? 'feishu-result--ok' : 'feishu-result--fail'
                    ]"
                  >
                    ● {{ rec.result }}
                  </span>
